...
(9, '公开相册2', 0, NULL, '无', NULL, 'photo/1560943264', '2019-06-19 19:21:04');
...
(54, 'admin', 69, '2019-06-14 18:59:42'),
(55, 'admin', 68, '2019-06-14 19:00:20'),
(56, 'admin', 69, '2019-06-14 19:00:30'),
(57, '游客', 69, '2019-06-19 19:14:56'),
(58, 'admin', 69, '2019-06-19 19:15:20'),
(59, 'admin', 69, '2019-06-19 19:15:27'),
(60, 'admin', 69, '2019-06-19 19:17:45');
...
(35, '我的图片', 'photo/1560943264/1560943284.jpg', '', 9, 'admin', 1, 0, '2019-06-19 19:21:32');
...
--
-- 表的结构 `tg_photo_history`
--

CREATE TABLE IF NOT EXISTS `tg_photo_history` (
  `tg_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '//ID',
  `tg_username` varchar(20) NOT NULL COMMENT '//浏览用户',
  `tg_dir_id` mediumint(8) unsigned NOT NULL COMMENT '//相册目录',
  `tg_date` datetime NOT NULL COMMENT '//浏览时间',
  PRIMARY KEY (`tg_id`),
  KEY `tg_dir_id` (`tg_dir_id`) COMMENT '//相册ID'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `tg_photo_history`
--

INSERT INTO `tg_photo_history` (`tg_id`, `tg_username`, `tg_dir_id`, `tg_date`) VALUES
(1, 'admin', 7, '2019-06-19 19:38:22'),
(2, 'admin', 7, '2019-06-19 19:38:34'),
(3, 'admin', 6, '2019-06-19 19:40:14'),
(4, 'admin', 2, '2019-06-19 19:40:20'),
(5, '游客', 2, '2019-06-19 19:40:34'),
(6, '游客', 6, '2019-06-19 19:40:36'),
(7, '游客', 6, '2019-06-19 19:40:41'),
(8, 'admin', 6, '2019-06-19 19:40:52'),
(9, 'admin', 6, '2019-06-19 19:40:54');
...
(33, 'ed62b9309e2d6581db6aee62158872e2029829a6', '', 1, 'admin', '7c4a8d09ca3762af61e59520943dc26494f8941b', '我是管理员', '9a2642da524958d2bd0a7a8227167a961dd8ab86', '277382367@qq.com', '1696482260', 'http://www.163.com', '女', 'face/m01.gif', 1, '我是系统管理员，有什么问题的可以反馈给我，我不会去解决的。', 1, '1560509152', '1560502131', '2019-05-22 08:35:27', '2019-06-19 19:40:50', '127.0.0.1', 68),
...
--
-- 限制表 `tg_photo_history`
--
ALTER TABLE `tg_photo_history`
  ADD CONSTRAINT `tg_photo_history_ibfk_1` FOREIGN KEY (`tg_dir_id`) REFERENCES `tg_dir` (`tg_id`) ON DELETE CASCADE ON UPDATE CASCADE;
